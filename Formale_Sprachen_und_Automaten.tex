...
\section{Chomsky Grammatiken und kontextfreie Sprachen}
    ...
    \subsection{Typ2 Kontextfreie}
	  ...
	  \subsubsection{Cocke-Younger-Kasami(CYK)-Algorythmus}
    ...
    \subsection{Chomskynormalform CNF}
	  ...
	  1. $A \rightarrow BC$ oder 2. $A \rightarrow a$ mit $A,B,C \in Nichtterminalsymbole \; \wedge \; a \in Terminalsymbole$\\
	  \textbf{Vorgehen:}
	  \begin{enumerate}
		\item Extra Regeln für Terminalsymbole einführen
	  \end{enumerate}
